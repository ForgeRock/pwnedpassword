...
public class HaveIBeenPwnedPasswordNodePlugin extends AbstractNodeAmPlugin {
     ...
     */
    @Inject
    public HaveIBeenPwnedPasswordNodePlugin(AnnotatedServiceRegistry serviceRegistry) {
    ...
    protected Iterable<? extends Class<? extends Node>> getNodes() {
        return asList(
                HaveIBeenPwnedPasswordNode.class
        );
    }

    @Override
    public void upgrade(String fromVersion) throws PluginException {
        pluginTools.upgradeAuthNode(HaveIBeenPwnedPasswordNode.class);
